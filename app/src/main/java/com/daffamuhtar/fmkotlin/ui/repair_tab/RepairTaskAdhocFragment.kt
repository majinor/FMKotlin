...
class RepairTaskAdhocFragment : Fragment() {
...
//    var userAdapter: RepairDataBindingAdapter = RepairDataBindingAdapter()
    ...
    private lateinit var repairOnAdhocViewModel: RepairTaskAdhocFragmentViewModel

    private lateinit var binding: FragmentRepairTaskAdhocBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRepairTaskAdhocBinding.inflate(inflater)
        return binding.root
    ...
    private fun declare() {
        ...
        repairOnAdhocViewModel = RepairTaskAdhocFragmentViewModel(
