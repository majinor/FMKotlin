...
import com.daffamuhtar.fmkotlin.databinding.FragmentRepairOnPeriodBinding
...
class RepairOngoingPeriodFragment : Fragment() {
    ...
    private lateinit var binding: FragmentRepairOnPeriodBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRepairOnPeriodBinding.inflate(inflater)
        return binding.root
    }
    ...
    private fun callData() {
        repairOngoingPeriodViewModel.getRepairPeriod(context, ConstantsApp.BASE_URL_V2_0, "MEC-MBA-99")
    ...
    private fun setReportResults(repairs: List<com.daffamuhtar.fmkotlin.data.remote.response.RepairOnPeriodResponse>) {
        repairList.clear()
