...
import com.daffamuhtar.fmkotlin.databinding.FragmentRepairTaskTireBinding
...
class RepairTaskTireFragment : Fragment() {
...
//    var userAdapter: RepairDataBindingAdapter = RepairDataBindingAdapter()
    ...
    private lateinit var viewModel: RepairTaskTireFragmentViewModel

    private lateinit var binding: FragmentRepairTaskTireBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRepairTaskTireBinding.inflate(inflater)
        return binding.root
    ...
    private fun declare() {
        ...
        viewModel = RepairTaskTireFragmentViewModel(
