...
import com.daffamuhtar.fmkotlin.databinding.FragmentRepairTaskPeriodBinding
...
class RepairTaskPeriodFragment : Fragment() {
...
//    var userAdapter: RepairDataBindingAdapter = RepairDataBindingAdapter()
    ...
    private lateinit var viewModel: RepairTaskPeriodFragmentViewModel

    private lateinit var binding: FragmentRepairTaskPeriodBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRepairTaskPeriodBinding.inflate(inflater)
        return binding.root
    ...
    private fun declare() {
        ...
        viewModel = RepairTaskPeriodFragmentViewModel(
