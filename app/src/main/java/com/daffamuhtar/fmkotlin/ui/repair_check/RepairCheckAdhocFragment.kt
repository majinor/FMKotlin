...
import com.daffamuhtar.fmkotlin.databinding.FragmentRepairCheckAdhocBinding
...
class RepairCheckAdhocFragment : Fragment() {
...
//    var userAdapter: RepairDataBindingAdapter = RepairDataBindingAdapter()
    ...
    private lateinit var repairOnAdhocViewModel: RepairCheckAdhocFragmentViewModel

    private lateinit var binding: FragmentRepairCheckAdhocBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRepairCheckAdhocBinding.inflate(inflater)
        return binding.root
    ...
    private fun declare() {
        ...
        repairOnAdhocViewModel = RepairCheckAdhocFragmentViewModel(
        ...
        collectLast(repairOnAdhocViewModel.repairPagingData, ::setRepairList)
...
//    ===================
    ...
    private fun setAdapter() {
        ...
        repairOnAdhocViewModel.dogBreeds.observe(requireActivity()){
