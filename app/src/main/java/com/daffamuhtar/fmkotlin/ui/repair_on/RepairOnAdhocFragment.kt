...
class RepairOnAdhocFragment : Fragment() {
...
//    var userAdapter: RepairDataBindingAdapter = RepairDataBindingAdapter()
    ...
    private lateinit var repairOnAdhocViewModel: RepairOnAdhocFragmentViewModel
    ...
    private fun declare() {
        ...
        repairOnAdhocViewModel = RepairOnAdhocFragmentViewModel(
